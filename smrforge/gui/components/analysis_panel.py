                    ...
                    dbc.CardBody(
                        [
                            dbc.RadioItems(
                                ...
                                options=[
                                    {
                                        "label": "Neutronics (k-eff calculation)",
                                        "value": "neutronics",
                                    },
                                    {"label": "Burnup Analysis", "value": "burnup"},
                                    {
                                        "label": "Quick Transient Analysis",
                                        "value": "quick_transient",
                                    },
                                    {"label": "Safety Transient", "value": "safety"},
                                    {
                                        "label": "Lumped Thermal Hydraulics",
                                        "value": "lumped_thermal",
                                    },
                            ...
                            dbc.Col(
                                [
                                    ...
                                    dcc.Dropdown(
                                        ...
                                        options=[
                                            {
                                                "label": "Reactivity Insertion Accident (RIA)",
                                                "value": "reactivity_insertion",
                                            },
                                            {
                                                "label": "Reactivity Step Change",
                                                "value": "reactivity_step",
                                            },
                                            {
                                                "label": "Power Change Transient",
                                                "value": "power_change",
                                            },
                                            {
                                                "label": "Decay Heat Removal (Long-term)",
                                                "value": "decay_heat",
                                            },
                                        ],
                                        value="reactivity_insertion",
                        ...
                        [
                            dbc.Col(
                                [
                                    ...
                                    dbc.FormText(
                                        "Only used for reactivity insertion/step types"
                                    ),
                                ],
                                width=6,
                            ),
                            ...
                            dbc.Col(
                                [
                                    ...
                                    dbc.Checklist(
                                        ...
                                        options=[
                                            {
                                                "label": "Enable for transients > 1 day",
                                                "value": True,
                                            }
                                        ],
                                        value=[],
                            ...
                            dbc.Col(
                                [
                                    ...
                                    dbc.Checklist(
                                        ...
                                        options=[
                                            {
                                                "label": "Show plot after analysis",
                                                "value": True,
                                            }
                                        ],
                                        value=[True],
                            ...
                            dbc.Col(
                                [
                                    ...
                                    dcc.Dropdown(
                                        ...
                                        options=[
                                            {
                                                "label": "Steam Line Break (SLB)",
                                                "value": "slb",
                                            },
                                            {
                                                "label": "Feedwater Line Break (FWLB)",
                                                "value": "fwlb",
                                            },
                                            {
                                            ...
                                            {
                                                "label": "Large Break LOCA",
                                                "value": "lb_loca",
                                            },
                                            {
                                                "label": "Loss of Flow (LOFC)",
                                                "value": "lofc",
                                            },
                                        ],
                                        value="slb",
                            ...
                            dbc.Col(
                                [
                                    ...
                                    dbc.Checklist(
                                        ...
                                        options=[
                                            {
                                                "label": "Enable adaptive stepping",
                                                "value": True,
                                            }
                                        ],
                                        value=[True],
                            ...
                            dbc.Col(
                                [
                                    ...
                                    dbc.Select(
                                        ...
                                        options=[
                                            {
                                                "label": "Default (2-lump: fuel + moderator)",
                                                "value": "default",
                                            },
                                            {
                                                "label": "Custom (specify in config file)",
                                                "value": "custom",
                                            },
                                        ],
                                        value="default",
