                                    ...
                                    dbc.Col(
                                        [
                                            ...
                                            dcc.Dropdown(
                                                ...
                                                options=[
                                                    {
                                                        "label": "Prismatic HTGR",
                                                        "value": "prismatic",
                                                    },
                                                    {
                                                        "label": "Pebble Bed HTGR",
                                                        "value": "pebble_bed",
                                                    },
                                                    {
                                                        "label": "PWR SMR",
                                        ...
                                        [
                                            ...
                                            dbc.ButtonGroup(
                                                [
                                                    dbc.Button(
                                                        "Clear",
                                                        id="geometry-clear-btn",
                                                        color="warning",
                                                        size="sm",
                                                    ),
                                                    dbc.Button(
                                                        "Reset",
                                                        id="geometry-reset-btn",
                                                        color="secondary",
                                                        size="sm",
                                                    ),
                                                    dbc.Button(
                                                        "Export",
                                                        id="geometry-export-btn",
                                                        color="success",
                                                        size="sm",
                                                    ),
                                                    dbc.Button(
                                                        "Import",
                                                        id="geometry-import-btn",
                                                        color="info",
                                                        size="sm",
                                                    ),
                                                ]
                            ...
                            dbc.Card(
                                [
                                    ...
                                    dbc.CardBody(
                                        [
                                            html.Div(
                                                id="geometry-material-palette",
                                                children=_create_material_palette(),
                                            ),
                                            html.Hr(),
                                        ...
                                        [
                                            dbc.ButtonGroup(
                                                [
                                                    dbc.Button(
                                                        "Select",
                                                        id="geometry-tool-select",
                                                        color="primary",
                                                        active=True,
                                                    ),
                                                    dbc.Button(
                                                        "Paint",
                                                        id="geometry-tool-paint",
                                                        color="primary",
                                                    ),
                                                    dbc.Button(
                                                        "Fill",
                                                        id="geometry-tool-fill",
                                                        color="primary",
                                                    ),
                                                    dbc.Button(
                                                        "Erase",
                                                        id="geometry-tool-erase",
                                                        color="danger",
                                                    ),
                                                ],
                                                vertical=True,
