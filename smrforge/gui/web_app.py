...
def create_app() -> Optional["dash.Dash"]:
    ...
    app.layout = dbc.Container(
        [
            ...
            dcc.Store(
                id="project-store",
                data={"name": None, "path": None, "status": None, "message": None},
            ),
            ...
            dbc.Row(
                [
                    # Sidebar
                    dbc.Col([create_sidebar()], width=3, className="border-end"),
                    # Main content
                    dbc.Col(
                        [
                            html.Div(
                                id="main-content", children=create_reactor_builder()
                            )
                        ],
                        width=9,
                    ),
                        ...
                        [
                            ...
                            html.P(
                                [
                                    ...
                                    html.A(
                                        "Documentation",
                                        href="https://github.com/SMRFORGE/smrforge",
                                        target="_blank",
                                    ),
                                    " | ",
                                    html.A(
                                        "CLI Available", href="#", id="cli-info-link"
                                    ),
                                ],
...
def run_server(
    host: str = "127.0.0.1", port: int = 8050, debug: bool = False, **kwargs
) -> None:
    """
