    ...
    if backend == "plotly":
        ...
        if burnup_without_rods is not None:
            if hasattr(burnup_without_rods, "times"):
                ...
                inventory_no_rods = burnup_without_rods.get(
                    "inventory", burnup_without_rods
                )
...
def plot_burnup_dashboard_enhanced(
    ...
    **kwargs,
    ...
    base_fig = plot_burnup_dashboard(
        inventory, time_unit=time_unit, backend=backend, title=title, **kwargs
    )
