...
GROUP_STRUCTURES = {
    'SCALE-44': np.array([  # 44-group structure (high to low)
        2.0e7, 6.376e6, 3.012e6, 1.827e6, 1.423e6, 9.072e5, 4.076e5,
        1.111e5, 1.503e4, 3.035e3, 5.830e2, 1.013e2, 2.902e1, 1.068e1,
        3.059, 1.855, 1.300, 1.125, 1.0, 8.764e-1, 6.826e-1, 6.250e-1,
        5.315e-1, 5.0e-1, 4.140e-1, 3.25e-1, 2.75e-1, 2.25e-1, 1.5e-1,
        1.0e-1, 6.75e-2, 5.0e-2, 3.75e-2, 2.5e-2, 1.0e-2, 7.5e-3,
        5.0e-3, 4.0e-3, 3.0e-3, 2.5e-3, 2.0e-3, 1.5e-3, 1.0e-3, 5.0e-4, 1.0e-5
    ]),
    
    'HTGR-8': np.array([  # Optimized 8-group for HTGR
        1.0e7, 8.21e5, 5.53e3, 6.25, 3.93e-1, 1.0e-1, 1.86e-2, 4.0e-3, 1.0e-5
    ]),
    
    'CASMO-16': np.array([  # 16-group structure
        1.0e7, 8.187e5, 5.531e3, 6.267e1, 9.877, 4.0, 2.5, 2.25, 1.855,
        1.3, 1.125, 1.0, 6.25e-1, 3.5e-1, 2.8e-1, 1.4e-1, 5.8e-2, 1.0e-5
    ]),
