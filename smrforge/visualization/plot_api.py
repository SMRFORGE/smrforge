...
class Plot:
    ...
    color_by: str = "material"  # 'material', 'cell', 'flux', 'power', 'temperature', 'density'
    ...
    def _plot_slice(self, geometry, data: Optional[np.ndarray], field_name: Optional[str]):
    ...
    def _plot_voxel(self, geometry, data: Optional[np.ndarray], field_name: Optional[str]):
    ...
    def _plot_ray_trace(self, geometry, data: Optional[np.ndarray], field_name: Optional[str]):
    ...
    def _plot_unstructured(self, geometry, data: Optional[np.ndarray], field_name: Optional[str]):
        ...
        if self.backend == "plotly":
            ...
            raise ValueError(f"Unstructured plots only support 'plotly' or 'pyvista', not '{self.backend}'")
