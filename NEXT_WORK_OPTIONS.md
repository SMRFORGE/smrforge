...
**See `THERMAL_SCATTERING_IMPLEMENTATION.md` and `IMPLEMENTATION_SUMMARY_OPTIONS_1_2_4_6.md` for details.**
...
**See `IMPLEMENTATION_SUMMARY_OPTIONS_1_2_4_6.md` for details.**
