...
class TestFileCopyErrorHandling:
    ...
    @pytest.mark.skip(reason="Requires valid ENDF file setup - covered by integration tests")
    def test_copy_local_endf_file_ioerror(self, temp_cache_dir, tmp_path):
        ...
        cache = NuclearDataCache(cache_dir=temp_cache_dir, local_endf_dir=endf_dir.parent)
...
class TestErrorMessages:
    ...
    @pytest.mark.skip(reason="Requires valid ENDF file setup - covered by integration tests")
    def test_copy_error_message_includes_permissions_hint(self, temp_cache_dir, tmp_path):
        ...
        with patch('shutil.copy2') as mock_copy:
            ...
            try:
                ...
                assert "file permissions" in error_msg.lower() or "disk space" in error_msg.lower()
