...
class TestParseMf3Section:
    ...
    def test_parse_mf3_section_endf_number_formats(
    ...
    def test_parse_mf3_section_removes_duplicates(
        self, endf_evaluation_class, temp_dir
    ):
    ...
    def test_parse_mf3_section_detects_section_boundary(
        self, endf_evaluation_class, temp_dir
    ):
    ...
    def test_parse_mf3_section_detects_different_mf(
        self, endf_evaluation_class, temp_dir
    ):
    ...
    def test_parse_mf3_section_start_idx_out_of_range(
        self, endf_evaluation_class, temp_dir
    ):
    ...
    def test_parse_mf3_section_handles_invalid_numbers(
        self, endf_evaluation_class, temp_dir
    ):
    ...
    def test_parse_mf3_section_negative_exponents(
        self, endf_evaluation_class, temp_dir
    ):
    ...
    def test_parse_mf3_section_handles_mt_zero_continuation(
        self, endf_evaluation_class, temp_dir
    ):
