...
from smrforge.workflows.templates import (
    ReactorTemplate,
    TemplateLibrary
)
...
class TestReactorTemplate:
    ...
    def test_to_dict(self):
        ...
        template = ReactorTemplate(
            ...
            parameters={
                "enrichment": {"default": 0.195, "type": "float", "description": "Enrichment"}
            }
        )
    ...
    def test_instantiate_no_base_preset(self):
        ...
        template = ReactorTemplate(
            name="test_template",
            parameters={
                "enrichment": {"default": 0.195, "type": "float"}
            }
        )
    ...
    def test_validate_missing_default(self):
        ...
        template = ReactorTemplate(
            name="test_template",
            parameters={
                "enrichment": {"type": "float"}  # Missing default
            }
        )
    ...
    def test_validate_missing_type(self):
        ...
        template = ReactorTemplate(
            name="test_template",
            parameters={
                "enrichment": {"default": 0.195}  # Missing type
            }
        )
