...
class TestControlRodBank:
    ...
    def test_bank_total_worth(self):
        ...
        bank = ControlRodBank(
            id=1, name="A", max_worth=1000.0
        )  # 1000 pcm when fully inserted
...
class TestControlRodSequence:
    ...
    def test_sequence_with_steps(self):
        ...
        sequence = ControlRodSequence(
            name="Startup", steps=steps, description="Test sequence"
        )
        assert sequence.name == "Startup"
...
class TestControlRodWorthAtPosition:
    ...
    def test_worth_at_position_no_worth(self):
        ...
        rod = ControlRod(
            id=1, position=Point3D(0, 0, 0), length=400.0, diameter=5.0, worth=None
        )
    ...
    def test_worth_at_position_outside_inserted_length(self):
        ...
        rod = ControlRod(
            id=1, position=Point3D(0, 0, 0), length=400.0, diameter=5.0, worth=1000.0
        )
    ...
    def test_worth_at_position_zero_length(self):
        ...
        rod = ControlRod(
            id=1, position=Point3D(0, 0, 0), length=0.0, diameter=5.0, worth=1000.0
        )
...
class TestControlRodSystem:
    ...
    def test_system_execute_sequence_bank_not_found(self):
        ...
        system = ControlRodSystem()
        sequence = ControlRodSequence(
            name="Startup", steps=[("MissingBank", 0.5, 10.0)]
        )
    ...
    def test_system_execute_sequence_with_dependency_check(self):
        ...
        bank = ControlRodBank(
            id=2, name="BankA", max_worth=1000.0, dependencies=["DepBank"]
        )
    ...
    def test_system_calculate_worth_at_position(self):
        ...
        worth = system.calculate_worth_at_position(
            position, axial_position=100.0, core_radius=150.0
        )
    ...
    def test_system_calculate_worth_at_position_with_radial_profile(self):
        ...
        worth_center = system.calculate_worth_at_position(
            center_position, axial_position=100.0, core_radius=150.0
        )

        # Edge position (r near core_radius)
        edge_position = Point3D(140, 0, 100)
        worth_edge = system.calculate_worth_at_position(
            edge_position, axial_position=100.0, core_radius=150.0
        )
    ...
    def test_system_calculate_worth_at_position_zero_radius(self):
        ...
        position = Point3D(10, 10, 100)
        worth = system.calculate_worth_at_position(
            position, axial_position=100.0, core_radius=0.0
        )
        assert worth >= 0
    ...
    def test_system_sequenced_insertion_by_priority(self):
        ...
        system = ControlRodSystem()
        bank1 = ControlRodBank(
            id=1, name="A", priority=BankPriority.SAFETY, max_worth=1000.0
        )
        bank2 = ControlRodBank(
            id=2, name="B", priority=BankPriority.REGULATION, max_worth=500.0
        )
    ...
    def test_system_sequenced_insertion_by_dependency(self):
        ...
        system = ControlRodSystem()
        dep_bank = ControlRodBank(
            id=1, name="DepBank", priority=BankPriority.SAFETY, max_worth=1000.0
        )
        ...
        bank = ControlRodBank(
            id=2,
            name="Bank",
            priority=BankPriority.REGULATION,
            max_worth=500.0,
            dependencies=["DepBank"],
        )
        ...
        system.sequenced_insertion(
            target_insertion=0.05, order_by_priority=False
        )  # Insert to 0.05 (same as DepBank)
    ...
    def test_system_sequenced_insertion_dependency_violation(self):
        ...
        bank = ControlRodBank(
            id=2, name="Bank", max_worth=500.0, dependencies=["DepBank"]
        )
        system.add_bank(bank)
    ...
    def test_system_create_standard_sequence(self):
        ...
        system = ControlRodSystem()
        reg_bank = ControlRodBank(
            id=1, name="Reg", priority=BankPriority.REGULATION, max_worth=500.0
        )
        safety_bank = ControlRodBank(
            id=2, name="Safety", priority=BankPriority.SAFETY, max_worth=1000.0
        )

        system.add_bank(reg_bank)
        system.add_bank(safety_bank)

        sequence = system.create_standard_sequence(
            "Startup", withdrawal_steps=5, regulation_first=True
        )
        assert sequence.name == "Startup"
        assert len(sequence.steps) > 0
    ...
    def test_system_create_standard_sequence_not_regulation_first(self):
        ...
        sequence = system.create_standard_sequence(
            "Startup", withdrawal_steps=3, regulation_first=False
        )
        assert sequence.name == "Startup"
        assert len(sequence.steps) > 0
