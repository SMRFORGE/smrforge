...
class TestENDFCompatibilityContains:
    ...
    def test_contains_existing_reaction(
    ...
    def test_contains_nonexistent_reaction(
        self, endf_compatibility_class, complete_endf_file_with_reactions
    ):
    ...
    def test_contains_delegates_to_evaluation(
        self, endf_compatibility_class, complete_endf_file_with_reactions
    ):
...
class TestENDFCompatibilityGetItem:
    ...
    def test_getitem_returns_reaction_wrapper(
        self, endf_compatibility_class, complete_endf_file_with_reactions
    ):
    ...
    def test_getitem_energy_attribute(
        self, endf_compatibility_class, complete_endf_file_with_reactions
    ):
    ...
    def test_getitem_cross_section_attribute(
        self, endf_compatibility_class, complete_endf_file_with_reactions
    ):
    ...
    def test_getitem_xs_dictionary_structure(
        self, endf_compatibility_class, complete_endf_file_with_reactions
    ):
    ...
    def test_getitem_multiple_reactions(
        self, endf_compatibility_class, complete_endf_file_with_reactions
    ):
...
class TestENDFCompatibilityToPolars:
    ...
    def test_to_polars_contains_all_reactions(
        self, endf_compatibility_class, complete_endf_file_with_reactions
    ):
    ...
    def test_to_polars_data_correctness(
        self, endf_compatibility_class, complete_endf_file_with_reactions
    ):
        ...
        if df is not None:
            ...
            assert np.allclose(
                xs_from_df[sort_idx_df], rxn_data.cross_section[sort_idx_rxn]
            )
...
class TestENDFCompatibilityGetReactionsDataframe:
    ...
    def test_get_reactions_dataframe_contains_all_reactions(
        self, endf_compatibility_class, complete_endf_file_with_reactions
    ):
    ...
    def test_get_reactions_dataframe_summary_statistics(
        self, endf_compatibility_class, complete_endf_file_with_reactions
    ):
