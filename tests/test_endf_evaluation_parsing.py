...
"""
    ...
    def test_parse_header_handles_invalid_za_line(
    ...
    def test_parse_header_finds_header_in_middle_of_file(
        self, endf_evaluation_class, temp_dir
    ):
...
class TestParseMf3:
    ...
    def test_parse_mf3_creates_reaction_data_objects(
        self, endf_evaluation_class, temp_dir
    ):
    ...
    def test_parse_mf3_handles_invalid_control_records(
        self, endf_evaluation_class, temp_dir
    ):
...
"""
    ...
    def test_parse_file_integration_with_header_and_reactions(
        self, endf_evaluation_class, temp_dir
    ):
