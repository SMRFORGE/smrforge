...
class TestGeneticAlgorithm:
    ...
    def test_genetic_algorithm_invalid_bounds_empty(self):
        ...
        with pytest.raises(ValueError, match="Must provide at least one parameter bound"):
    ...
    def test_genetic_algorithm_invalid_bounds_inverted(self):
        ...
        with pytest.raises(ValueError, match="Upper bounds must be greater than lower bounds"):
...
class TestParticleSwarmOptimization:
    ...
    def test_initialize_positions(self):
        ...
        bounds = [(-1.0, 1.0), (-2.0, 2.0)]
        pso = ParticleSwarmOptimization(objective=objective, bounds=bounds, n_particles=10)
