...
class TestBurnupFuelManagerIntegration:
    ...
    def test_run_cycle_burnup(self, mock_fuel_manager, mock_neutronics_solver, mock_burnup_options, mock_burnup_solver):
        """Test run_cycle_burnup method."""
        integration = BurnupFuelManagerIntegration(mock_fuel_manager)
        
        # Mock BurnupSolver creation
        with patch('smrforge.burnup.solver.BurnupSolver', return_value=mock_burnup_solver):
    ...
    def test_run_cycle_burnup_no_update(self, mock_fuel_manager, mock_neutronics_solver, mock_burnup_options, mock_burnup_solver):
    ...
    def test_run_multi_cycle_burnup(self, mock_fuel_manager, mock_neutronics_solver, mock_burnup_options, mock_burnup_solver):
    ...
    def test_run_multi_cycle_burnup_no_pattern(self, mock_fuel_manager, mock_neutronics_solver, mock_burnup_options, mock_burnup_solver):
