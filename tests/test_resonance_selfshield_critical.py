...
class TestBondarenkoMethodCritical:
    ...
    def test_compute_background_xs_with_geometry(self):
        ...
        sigma_0_with_geom = method.compute_background_xs(composition, geometry_factor=1.0)
...
class TestSubgroupMethodCritical:
    ...
    def test_compute_effective_xs_thermal(self):
        ...
        xs_eff = method.compute_effective_xs("U238", "capture", "thermal", sigma_0=100.0)
    ...
    def test_compute_effective_xs_various_sigma_0(self):
        ...
        for sigma_0 in [1.0, 10.0, 100.0, 1000.0, 10000.0]:
            xs_eff = method.compute_effective_xs("U238", "capture", "thermal", sigma_0=sigma_0)
            assert xs_eff > 0
            assert np.isfinite(xs_eff)
    ...
    def test_tabulate_effective_xs(self):
        ...
        xs_table = method.tabulate_effective_xs("U238", "capture", "thermal", sigma_0_range)
...
class TestEquivalenceTheoryCritical:
    ...
    def test_compute_triso_shielding_various_geometries(self):
        ...
        geometries = [
            {"kernel_radius": 100e-4, "buffer_thickness": 50e-4, "packing_fraction": 0.25},
            {"kernel_radius": 212.5e-4, "buffer_thickness": 100e-4, "packing_fraction": 0.35},
            {"kernel_radius": 300e-4, "buffer_thickness": 150e-4, "packing_fraction": 0.45},
        ]
