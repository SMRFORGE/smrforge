...
class TestControlIntegrationExtendedEdgeCases:
    ...
    def test_create_controlled_reactivity_state_with_none_temperature_fallback(
    ...
    def test_create_controlled_reactivity_state_with_t_fuel(
        self, mock_reactor_controller
    ):
    ...
    def test_create_load_following_reactivity_state_with_none_temperature_fallback(
    ...
    def test_create_load_following_reactivity_state_with_t_fuel(
        self, mock_load_controller
    ):
    ...
    def test_create_controlled_reactivity_control_step_exception(
        self, mock_reactor_controller
    ):
    ...
    def test_create_load_following_reactivity_control_step_exception(
        self, mock_load_controller
    ):
        """Test load following when control_step raises an exception."""
        mock_load_controller.control_step.side_effect = RuntimeError(
    ...
    def test_create_controlled_reactivity_zero_initial_time_dt_zero(
        self, mock_reactor_controller
    ):
    ...
    def test_create_load_following_reactivity_zero_initial_time_dt_zero(
        self, mock_load_controller
    ):
    ...
    def test_create_load_following_reactivity_state_temperature_only_via_get(
        self, mock_load_controller
    ):
    ...
    def test_create_controlled_reactivity_state_power_only_no_temp_update(
        self, mock_reactor_controller
    ):
    ...
    def test_create_load_following_reactivity_state_power_only_no_temp_update(
        self, mock_load_controller
    ):
