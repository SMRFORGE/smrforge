...
class TestUnitsExtended:
    ...
    def test_units_with_mocked_pint(self):
        ...
        try:
            ...
            result = smrforge.utils.units.check_units(
                mock_quantity_obj, "megawatt", "power"
            )
            ...
            result = smrforge.utils.units.convert_units(
                mock_quantity_obj, mock_target_quantity
            )
            assert result == 10000000.0
