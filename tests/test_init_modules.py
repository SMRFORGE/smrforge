...
class TestCoreInit:
    ...
    def test_import_core_reactor_core(self):
        ...
        from smrforge.core import Library, NuclearDataCache, Nuclide
    ...
    def test_import_core_endf_parser(self):
        ...
        from smrforge.core import ENDFCompatibility, ENDFEvaluation, ReactionData
...
class TestNeutronicsInit:
    ...
    def test_import_neutronics_solver(self):
        ...
        from smrforge.neutronics import MultiGroupDiffusion, NeutronicsSolver
...
class TestThermalInit:
    ...
    def test_import_thermal_hydraulics(self):
        ...
        from smrforge.thermal import ChannelThermalHydraulics, ThermalHydraulics
...
class TestMainInit:
    ...
    def test_get_version_returns_version_string(self):
        ...
        from smrforge import __version__, get_version
    ...
    def test_import_neutronics_from_main(self):
        ...
        from smrforge import MultiGroupDiffusion, NeutronicsSolver
    ...
    def test_import_thermal_from_main(self):
        ...
        from smrforge import ChannelThermalHydraulics, ThermalHydraulics
    ...
    def test_import_gamma_transport_from_main(self):
        ...
        from smrforge import GammaTransportOptions, GammaTransportSolver
...
class TestInitImportErrors:
    ...
    def test_main_init_import_error_neutronics(self):
        ...
        with patch.dict(sys.modules, {"smrforge.neutronics": None}):
            ...
            with warnings.catch_warnings(record=True) as w:
                ...
                assert len(w) > 0
                assert any(
                    "neutronics" in str(warning.message).lower() for warning in w
                )
    ...
    def test_geometry_init_import_error(self):
        ...
        pytest.skip(
            "Complex reloading test - ImportError handling already covered in specific tests"
        )
    ...
    def test_main_init_import_error_decay_heat_gamma(self):
        ...
        with patch.dict(
            sys.modules, {"smrforge.decay_heat": None, "smrforge.gamma_transport": None}
        ):
            import importlib
    ...
    def test_main_init_import_error_convenience_fallback(self):
        """Test main __init__ handles convenience import failure (ImportError path)."""
        import builtins
        ...
        def guarded_import(name, *args, **kwargs):
            if name == "smrforge.convenience":
                raise ImportError("forced convenience import failure")
        ...
        with patch.object(builtins, "__import__", guarded_import):
            ...
            assert hasattr(main_module, "__all__")
            assert "_CONVENIENCE_AVAILABLE" in dir(main_module)
            assert main_module._CONVENIENCE_AVAILABLE is False
...
class TestBurnupInit:
    ...
    def test_burnup_init_import_error_fuel_management(self):
        ...
        with patch.dict(
            sys.modules, {"smrforge.burnup.fuel_management_integration": None}
        ):
            import importlib
...
class TestUtilsInit:
    ...
    def test_import_utils_logo(self):
        ...
        from smrforge.utils import get_logo_data, get_logo_path
    ...
    def test_utils_init_import_error_memory_utils(self):
        ...
        with patch.dict(
            sys.modules,
            {"smrforge.utils.memory_mapped": None, "smrforge.utils.memory_pool": None},
        ):
            import importlib
