...
class TestUnitsEdgeCases:
    ...
    def test_check_units_name_parameter(self):
        ...
        assert (
            "my_power" in str(exc_info.value) or "power" in str(exc_info.value).lower()
        )
    ...
    def test_reactor_units_dollar_conversion(self):
        ...
        from smrforge.utils.units import convert_units, get_ureg, with_units
        ...
        try:
            ...
            pytest.skip(
                "Pint dimensionless conversion for dollar not supported in this version"
            )
    ...
    def test_reactor_units_pcm_conversion(self):
        ...
        try:
            ...
            pytest.skip(
                "Pint dimensionless conversion for pcm not supported in this version"
            )
