...
class TestSweepConfig:
    ...
    def test_get_parameter_values_range(self):
        ...
        config = SweepConfig(
            parameters={"enrichment": (0.10, 0.25, 0.05)},
            analysis_types=["keff"]
        )
    ...
    def test_get_parameter_values_invalid(self):
        ...
        config = SweepConfig(
            parameters={"invalid": "not a tuple or list"},
            analysis_types=["keff"]
        )
