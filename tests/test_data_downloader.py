...
class TestExpandElementsToNuclidesExtended:
    ...
    def test_expand_elements_to_nuclides_thorium(self):
        ...
        nuclides = downloader_module._expand_elements_to_nuclides(["Th"], Library.ENDF_B_VIII_1)
        assert isinstance(nuclides, list)
    ...
    def test_expand_elements_to_nuclides_hydrogen(self):
        ...
        nuclides = downloader_module._expand_elements_to_nuclides(["H"], Library.ENDF_B_VIII_1)
        assert isinstance(nuclides, list)
    ...
    def test_expand_elements_to_nuclides_carbon(self):
        ...
        nuclides = downloader_module._expand_elements_to_nuclides(["C"], Library.ENDF_B_VIII_1)
        assert isinstance(nuclides, list)
...
class TestDownloadFileExtended:
    ...
    @patch('smrforge.data_downloader.requests')
    @patch('builtins.open', create=True)
    @pytest.mark.skipif(not downloader_module.TQDM_AVAILABLE, reason="tqdm not available")
...
class TestDownloadEndfDataExtended:
    ...
    def test_download_endf_data_with_organize(self, mock_organize, mock_validate, mock_download):
    ...
    @patch('smrforge.data_downloader.REQUESTS_AVAILABLE', True)
    @patch('smrforge.data_downloader.NuclearDataCache._validate_endf_file')
    def test_download_endf_data_with_isotopes(self, mock_validate, mock_download, mock_parse):
    ...
    @patch('smrforge.data_downloader.REQUESTS_AVAILABLE', True)
    @patch('smrforge.data_downloader.NuclearDataCache._validate_endf_file')
    def test_download_endf_data_with_nuclide_set(self, mock_validate, mock_download, mock_parse):
    ...
    @patch('smrforge.data_downloader.REQUESTS_AVAILABLE', True)
    @patch('smrforge.data_downloader.NuclearDataCache._validate_endf_file')
    def test_download_endf_data_full_library_fallback(self, mock_validate, mock_download, mock_parse):
    ...
    def test_download_endf_data_no_nuclides_error(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch('smrforge.data_downloader._parse_isotope_string', return_value=None):
    ...
    def test_download_endf_data_caches_successful_source(self, mock_cache, mock_validate, mock_download):
    ...
    @patch('smrforge.data_downloader.NuclearDataCache._validate_endf_file')
    @patch('pathlib.Path.exists')
    def test_download_endf_data_skips_existing_files(self, mock_exists, mock_validate, mock_download):
