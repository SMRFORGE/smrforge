...
class TestHybridSolver:
    ...
    def test_identify_complex_regions_from_flux(
        self, mock_diffusion_solver, mock_mc_solver
    ):
    ...
    def test_compute_flux_gradient_magnitude(
        self, mock_diffusion_solver, mock_mc_solver
    ):
    ...
    def test_solve_eigenvalue_with_mc_correction(
        self, mock_diffusion_solver, mock_mc_solver
    ):
...
class TestCreateHybridSolver:
    ...
    def test_create_hybrid_solver_non_adaptive(
        self, mock_diffusion_solver, mock_mc_solver
    ):
